...
@section('title', config('app.name') . ' -- Tambah Alat Lab')
        ...
        <div class="col-md-7">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1 small">
                    ...
                    <li class="breadcrumb-item active text-primary fw-semibold" aria-current="page">Tambah Alat</li>
                </ol>
            </nav>
            <h2 class="fw-bold mb-0">Tambah Data Alat Laboratorium</h2>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-header py-3 px-4 border-bottom d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0">Formulir Penambahan Alat Baru</h6>
                        <span class="text-muted small">Masukkan informasi perangkat lab yang ingin didaftarkan</span>
                    </div>
                </div>

                <!-- Form Body -->
                <div class="card-body p-4">
                    <form action="{{ route('alat.store') }}" method="POST" class="d-flex flex-column gap-3">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-secondary bg-opacity-10 text-muted border-end-0"><i class="bi bi-cpu"></i></span>
                                <input type="text" name="nama_alat" id="nama_alat" class="form-control border-start-0 ps-0" value="{{ old('nama_alat') }}" placeholder="Contoh: Oscilloscope Digital" required>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="kode_alat" id="kode_alat" class="form-control border-start-0 ps-0" value="{{ old('kode_alat') }}" placeholder="Contoh: LAB-ELC-001" required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary px-4 py-2.5 rounded-3 shadow-sm fw-semibold d-inline-flex align-items-center gap-2">
                                <i class="bi bi-save-fill"></i> Simpan Alat Baru
                            </button>
                        </div>
                    </form>
                </div>
